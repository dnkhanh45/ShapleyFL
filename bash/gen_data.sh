...
# python generate_fedtask.py --dataset mnist --dist 2 --skew 1 --num_clients 16 --zipf_skew 1.6 --seed 1
# python generate_fedtask.py --dataset cifar10 --dist 2 --skew 1 --num_clients 16 --zipf_skew 1.6 --seed 1
# python generate_fedtask.py --dataset fashion_mnist --dist 2 --skew 1 --num_clients 16 --zipf_skew 1.6 --seed 1